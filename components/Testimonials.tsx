...
const ReviewCard = ({ review, className = "", index }: { review: typeof reviews[0], className?: string, index: number }) => {
    ...
    return (
        ...
        >
            <Card className={`bg-white border-stone-100 shadow-lg hover:shadow-xl transition-shadow duration-300 h-full ${className}`}>
                <CardContent className="p-8 flex flex-col h-full min-h-[500px]">
                    ...
                    {review.reviewImages && review.reviewImages.length > 0 && (
                        <div
                            className="mb-6 rounded-lg overflow-hidden h-48 w-full relative group shrink-0"
...
const Testimonials = () => {
    return (
        <section
            ...
            style={{
                backgroundImage: `url('/images/white_gold_pattern.png')`,
